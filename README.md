...
- 이주용
  ...
  - 새로운 기술스택 쓰고, 크롤링 새로 해보고, 단톡 기능 구현해보고 하는 모든 과정이 맘대로 안풀려서 기본 2~3일씩 잡아먹었고, 나만 컴퓨터 이상해서 npm 안깔려서 막판에 프엔 고생하는데 도움도 못주고 해서 미안했습니다 문경이랑 태극이형 나랑 빽 개발하느라 고생많았고 윤식이는 리액트 슉슉 하는거 너무 멋있었고 용환이형은 적성 새로 찾은거 같아서 기쁩니다
  - 다들 판교에서 모여서 밥풀합시다
