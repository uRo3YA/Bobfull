...
for sk in search_keys:
    ...
    for l in lst:
        i += 1
        result = {"model": "restaurant.restaurant", "pk": i, "fields": {"name": 0, 'address': 0, 'category': 0, 'detail': ''}}
        URL = l
        ...
        cat = driver.find_element(By.CLASS_NAME, 'txt_location')
        result['fields']['category'] = category(cat)
